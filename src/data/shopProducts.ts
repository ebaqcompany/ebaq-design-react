...
export const shopProducts: ShopProduct[] = [
  {
    ...
    featureImage: '/images/site/shop-products/brand-strategy-script-mockup.jpg',
    ...
    story: {
      ...
      profileImage: '/images/site/creative-suite-sections/arek-dvornechuck-profile-pic-320.webp',
      videos: [
  ...
  },
  {
    ...
    story: { eyebrow: 'Become a storyteller', heading: 'Master the art of Storytelling', body: 'Hi! My name is Arek.\n\nI’m the author of this guide and I went from working at top branding agencies to launching my own studio.\n\nNow I share some of the top frameworks to help you succeed.\n\nThis is my story.', byline: 'Arek Dvornechuck', profileImage: '/images/site/creative-suite-sections/arek-dvornechuck-profile-pic-320.webp', videos: [{ title: 'The Brand Story Guide', wistiaId: 'm1y20zuis8' }] },
  ...
  },
  {
    ...
    featureImage: '/images/site/shop-products/project-proposal-template.webp',
    featureSecondaryImage: '/images/site/shop-products/proposal-vertical-mockup.webp',
  ...
  },
  {
    ...
    seo: {
      ...
      image: '/images/site/shop-products/one-page-style-guide-thumb.webp',
