...
export const Testimonial32Defaults: { heading: string; description: string; testimonials: Testimonial[] } = { heading: "What my clients say", description: "", testimonials: [
  ...
  { quote: '"After several failures of using Fiverr and 99designs to handle our rebranding project, we finally found Arek and Ebaq Design who nailed it at first. There was no time wasted, Arek was very organized and methodical about his approach from the start."', logo: { src: "/client-logos/medihuanna-wordmark-black.svg", alt: "Medihuanna", scale: 90 }, avatar: { src: "/images/site/testimonial32/1707340907658.webp", alt: "Pavel Bulkiewicz" }, name: "Pavel Bulkiewicz", position: "Founder, Medihuanna" },
  { quote: '"We had a terrific experience working with Arek on our logos and pitch deck. Highly recommended!"', logo: { src: "/client-logos/wingnut-logo-black.svg", alt: "Wingnut Social", scale: 105 }, avatar: { src: "/images/site/testimonial32/darla-powell.webp", alt: "Darla Powell" }, name: "Darla Powell", position: "Founder, Wingnut Social" },
  { quote: '"I liked the overall approach Arek brings on the table. To the point. Focused on the end result. Detailed workshop, to bring out the desired outcome. And most importantly, he has so much clarity on the subject, and he guided me so well, to reach a conclusion on how the brand should be perceived and portrayed as."', logo: { src: "/client-logos/ami-logo-black.svg", alt: "AMI", scale: 110 }, avatar: { src: "/images/site/testimonial32/dhruv-patel.webp", alt: "Dhruv Patel" }, name: "Dhruv Patel", position: "Founder, AMI" },
  { quote: '"After struggling to build our website on Squarespace and wasting valuable time with underwhelming designers on Upwork, we finally discovered Arek at Ebaqdesign—and what a game-changer that was. From the very start, he understood our vision, took control of the process, and delivered a brand transformation that exceeded all our expectations. The results were beyond anything we could have imagined!"', logo: { src: "/client-logos/brevidee-logo.svg", alt: "Brevidee", scale: 80 }, avatar: { src: "/images/site/testimonial32/unnamed.webp", alt: "Alan Rudt" }, name: "Alan Rudt", position: "Brevidee" },
  { quote: '"Arek is a branding expert with extensive experience in graphic design, logos, and web design. We have collaborated with him on several rebranding projects. I highly recommend him."', logo: { src: "/client-logos/airport-executive-logo.svg", alt: "Airport Executive" }, avatar: { src: "/images/site/testimonial32/1732141495505.webp", alt: "Chris Nixon" }, name: "Chris Nixon", position: "Founder, Airport Executive" },
  ...
  { quote: '"Arek is a magic visionary with sharp attention to detail."', logo: { src: "/client-logos/sweetgrass-logo-black.svg", alt: "SweetGrass", className: "testimonial-logo--sweetgrass" }, avatar: { src: "/images/site/testimonial32/jane.webp", alt: "Jane de Abreu" }, name: "Jane de Abreu", position: "Founder, SweetGrass" },
] };
