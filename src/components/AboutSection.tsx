      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-20 md:mb-28 lg:mb-36">
          <div className="lg:col-span-2">
            <p className="text-5xl md:text-7xl lg:text-8xl mb-4 md:mb-6">{greeting}</p>
        ...
        {/* Services section */}
        <div>
          <p className="text-base mb-6 md:mb-8">{servicesLabel}</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-24">
            <div className="flex flex-col gap-1">
              {servicesLeft.map((service, index) => (
                <p key={index} className="text-2xl md:text-3xl lg:text-4xl">{service}</p>
              ))}
            </div>
