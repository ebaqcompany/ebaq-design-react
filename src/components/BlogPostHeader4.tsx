    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="grid gap-x-20 gap-y-12 xl:grid-cols-2">
          <div className="mx-auto flex size-full max-w-lg flex-col items-start justify-start xl:order-2">
          ...
          <div className="mx-auto aspect-video w-full overflow-hidden bg-background-secondary xl:order-1 xl:self-center">
