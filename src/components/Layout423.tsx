...
export const Layout423Defaults = {
  ...
  features: [
    { tagline: "01", url: "/start", heading: "Brand Strategy", description: "Clarify what the brand stands for, who it needs to reach, and how it should compete before design decisions begin.", deliverables: ["Brand Audit", "Competitive Analysis", "Brand Positioning", "Customer & Audience Profiles", "Brand Tagline & Messaging"], linkLabel: "Book a call" },
    { tagline: "02", url: "/start", heading: "Logo Design", description: "Create a distinctive, practical logo that captures the brand idea and works clearly across digital and physical applications.", deliverables: ["Custom Logo Design", "Logo Concepts", "Logo Refinement", "Responsive Logo Set", "Logo Animation"], linkLabel: "Book a call" },
    { tagline: "03", url: "/start", heading: "Identity Systems", description: "Turn the logo into a coherent visual language that gives every brand touchpoint a recognizable and consistent character.", deliverables: ["Color Palette", "Type System", "Brand Guidelines", "Custom Visuals & Icons", "Pitch Decks", "Social Media Graphics"], linkLabel: "Book a call" },
    { tagline: "04", url: "/start", heading: "Web Design", description: "Design a clear, responsive website experience that brings the brand to life and guides visitors toward the right action.", deliverables: ["Figma UX/UI", "Website Design", "Wireframes", "Responsive Design", "Brand Messaging"], linkLabel: "Book a call" },
    { tagline: "05", url: "/start", heading: "Web Development", description: "Build the approved website into a responsive, maintainable experience with careful interaction and launch-ready implementation.", deliverables: ["Framer Development", "Webflow Development", "Responsive Build", "Custom Integrations", "CMS Setup", "Launch Support"], linkLabel: "Book a call" },
    { tagline: "06", url: "/start", heading: "Motion Graphics", description: "Use purposeful motion to make the identity more expressive, memorable, and effective across brand and digital channels.", deliverables: ["Logo Animation", "Motion Direction", "Brand Transitions", "Social Motion Assets", "Website Animation"], linkLabel: "Book a call" },
  ],
};
