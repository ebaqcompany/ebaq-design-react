    ...
    <section id="comparison" className="px-[5%] py-16 md:py-24 lg:py-28 bg-[#f5f5f5]">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <h2 className="mb-5 md:mb-6 whitespace-pre-line" style={{ fontFamily: "'Roboto Condensed', sans-serif", fontWeight: 600 }}>{heading}</h2>
        </div>
          ...
          {rows.map((row, index) => (
            <div key={index} className="grid grid-cols-2 gap-8">
              <div className="flex items-center gap-3 border-b border-black/20 py-5 md:py-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-5 text-[#00afec] md:size-6"><path d="M20 6 9 17l-5-5"/></svg>
...
export const ComparisonDefaults: Props = {
  ...
  rows: [
    { left: "$3k/wk or $10k/mo", right: "$25k - $100k+" },
    { left: "1 week to brand", right: "3 - 9 months or more" },
    { left: "Direct senior designer", right: "Account managers" },
